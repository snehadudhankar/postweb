            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white  navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php"></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto mr-lg-5">
                                    ...
                                    <li class="nav-item dropdown no-caret">
                                         <form class="page-header-signup " action="search.php" method="POST">

                                            <div class="form-row justify-content-center">
                                                <div class="">
                                                    <div class="form-group  ">
                                                        <input name="search-keyword" class="form-control form-control-solid rounded-pill bg-succses" type="text" placeholder="Search keyword..."/>
                                                    </div>
                                                </div>

                                                <div class="">
                                                    <button class="btn btn-teal btn-block btn-marketing rounded-pill text-center" type="submit">find</button>
                                                </div>
                                            </div>
                                        </form>
                                    </li>
...
<img src="img/bg2.png" class="img-fluid" style="max-width: 100%;">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="card-body">
                                            ...
                                            <div class="post-preview-meta">
                                                <img class="post-preview-meta-img" src="./img/sneha.jpeg" />
